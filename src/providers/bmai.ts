...
export const bmaiProvider: UpstreamProvider = {
  id: "bmai",
  name: "bmai.kun8.vip",
  defaultBaseUrl: "https://bmai.kun8.vip",

  loginLabel: "邮箱",
  credentialEnvPrefix: "BMAI",
  ...
  getExtraHeaders(url: string): Record<string, string> {
    if (url.includes("bmai.kun8.vip")) {
      return { "Host": "bmai.kun8.vip" }
    }
    return {}
  },
}
